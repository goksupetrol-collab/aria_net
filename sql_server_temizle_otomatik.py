# -*- coding: utf-8 -*-
"""
SQL Server Tüm İzleri Temizleme Scripti - Otomatik Mod
"""
import pyodbc
        ...
        try:
            ...
            for db_row in veritabanlari:
                ...
                try:
                    ...
                    # Her veritabanı için ayrı bağlantı kullan
                    conn_db = baglan()
                    if conn_db:
        ...
        try:
            ...
            for i in range(0, 10):
                try:
                    ...
                    pass
            yazdir("   OK: Error log arsivlenmis kayitlar temizlendi", log_dosya)
